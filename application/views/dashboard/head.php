...
<head>
    ...
    <title>Content Manager System | Panel de Control</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url('vendor/admin-lte/dist/css/skins/_all-skins.min.css'); ?>"><!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!-- Morris chart -->
    ...
    <link rel="stylesheet" href="<?php echo base_url('vendor/admin-lte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css'); ?>">
