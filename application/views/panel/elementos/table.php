                        ...
                        <td align="center">                              
                          <div class="btn-group" align="left">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              <li><a href="<?php echo site_url($controller.'/edit/'.$r['id_elemento']); ?>"><span class="glyphicon glyphicon-pencil"></span> Editar</a></li>                              
                              <li><a href="<?php echo site_url($controller.'/delete/'.$r['id_elemento']); ?>"><span class="glyphicon glyphicon-remove"></span> Eliminar</a></li>                                                            
                            </ul>
                          </div>
                        </td>
                      </tr>
