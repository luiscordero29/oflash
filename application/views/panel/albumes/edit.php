                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        ...
                                        <input type="text" name="album" id="album" class="form-control" maxlength="255" required autofocus value="<?php echo $row['album']; ?>">
                                    </div> 
                                    <div class="col-xs-3">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <textarea class="form-control" rows="3" name="descripcion" id="descripcion"><?php echo $row['descripcion']; ?></textarea>
                                    </div>                                                                                                     
                                </div>
