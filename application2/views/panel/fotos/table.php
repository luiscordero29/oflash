  <div class="container">
    <div class="row">                            
      ...
      <div class="panel-heading"><h4>GESTOR DE ELEMENTOS</h4></div>
      <div class="panel-body">
            ...
            <div class="row">
              ...
              <div align="right" class="col-xs-6">                                     
                <a href="<?php echo site_url('upload'); ?>" class="btn btn-primary"><i class="icon-file"></i> Nuevo Registro</a>       
              </div>
            </div>
              ...
              <div class="col-xs-12">
                ...
                <?php if($table){ ?>
                  ...
                  <tbody>
                      ...
                      <tr>
                        <td><img src="<?php echo base_url().'assets/files/'.$r['file_name']; ?>" alt="<?php echo $r['file_name']; ?>" class="img-thumbnail" width="80px" height="80px"></td>
                        <td>
                          <?php echo $r['album']; ?>
                        </td>
                        <td>
                          <?php echo $r['file_name']; ?><br /><b>URL:</b> 
                          <?php echo base_url().'assets/files/'.$r['file_name']; ?>
                        </td>
                        ...
                        <td align="center">                              
                          <div class="btn-group" align="left">
                            ...
                            <ul class="dropdown-menu" role="menu">                              
                              <li><a href="<?php echo site_url($controller.'/delete/'.$r['id_album']); ?>"><span class="glyphicon glyphicon-remove"></span> Eliminar</a></li>                                                            
                            </ul>
                          </div>
                        </td>
                      </tr>
