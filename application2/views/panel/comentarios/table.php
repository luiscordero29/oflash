  <div class="container">
    <div class="row">                            
      ...
      <div class="panel-heading"><h4>GESTOR DE COMENTARIOS</h4></div>
                ...
                <?php if($table){ ?>
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo  word_limiter($r['comentario'],30); ?></td>
                        <td><?php echo $r['titulo']; ?></td>
                        <td><?php echo date("d/m/Y", strtotime($r['fecha_publicado'])); ?></td>                        
                        ...
                        <td align="center">                              
                          <div class="btn-group" align="left">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              <li><a href="<?php echo site_url($controller.'/edit/'.$r['id_comentario']); ?>"><span class="glyphicon glyphicon-pencil"></span> Editar</a></li>                              
                              <li><a href="<?php echo site_url($controller.'/delete/'.$r['id_comentario']); ?>"><span class="glyphicon glyphicon-remove"></span> Eliminar</a></li>                                                            
                            </ul>
                          </div>
                        </td>
                      </tr>
