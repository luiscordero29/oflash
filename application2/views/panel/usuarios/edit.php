                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-xs-2">
                                        ...
                                        <input type="text" name="usuario" id="usuario" class="form-control" maxlength="15" value="<?php echo $row['usuario']; ?>">
                                    </div>
                                    <div class="col-xs-10">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <input type="text" name="correo" id="correo" class="form-control" maxlength="100" required value="<?php echo $row['correo']; ?>">
                                    </div> 
                                </div>
